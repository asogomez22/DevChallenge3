...
interface GameData {
  id: string;
  players: any[];
  // ... (otros campos si los necesitas mostrar)
}
interface LobbyProps {
  ...
  onCreateGame: (isPublic: boolean) => void;
        ...
        <main className="lobby-main">
                ...
                {publicGames.length === 0 ? (
                  ...
                  publicGames.map((g) => (
                    <li key={g.id} onClick={() => onJoinWithCode(g.id)}>
                      <span>Partida de {g.players[0]?.displayName || 'Anònim'}</span>
          ...
          <div className="lobby-column profile-column">
            ...
            <div className="lobby-box">
              ...
              <button onClick={() => onCreateGame(isCreatingPublic)} className="btn-create" disabled={!socket}>
